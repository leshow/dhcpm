...
pub mod decline_mod {
    ...
    pub fn get_req_addr(args: &mut DeclineArgs) -> Option<String> {
        args.req_addr.map(|r| r.to_string())
    }
    #[rhai_fn(global, set = "req_addr")]
    pub fn set_req_addr(args: &mut DeclineArgs, req_addr: &str) {
    ...
    pub fn get_relay_link(args: &mut DeclineArgs) -> Option<String> {
        args.relay_link.map(|r| r.to_string())
    }
    #[rhai_fn(global, set = "relay_link")]
    pub fn set_relay_link(args: &mut DeclineArgs, relay_link: &str) {
    ...
    pub fn get_sident(args: &mut DeclineArgs) -> Option<String> {
        args.sident.map(|r| r.to_string())
    }
    #[rhai_fn(global, set = "sident")]
    pub fn set_sident(args: &mut DeclineArgs, sident: &str) {
